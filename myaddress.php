							...
							<ul class="right hide-on-med-and-down">
								...
								<li>
									<a id="logout" href="logout.php">
										<img class="logout" src="image/sign-out.png" style="">
									</a>
								</li>
							</ul>
						</div>
				...
				<ul class="side-nav fixed clearfix left" id="nav-mobile" style="transform: translateX(0px);">
					<li>
						<ul class="vm1 collapsible" data-collapsible="accordion" style="margin-top: 30px;">
							...
							<li id="ms3" class="active"><a style="color: #e0c158;" href="myaddress.php" class="collapsible-header">My Addresses</a></li>
...
<tbody>                        <?php
                                    if (!empty($new_address)) {
                                        echo "<tr><td> <strong>".$new_address."</strong><span class=\"badge badge-success\">New<span></td>"
                                    ?>
								...
								<?php
                                    ...
                                    } elseif ((count($addressList)== 0) && empty($new_address)) {
