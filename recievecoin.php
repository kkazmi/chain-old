				...
				<ul class="side-nav fixed clearfix left" id="nav-mobile" style="transform: translateX(0px);">
					<li>
						<ul class="vm1 collapsible" data-collapsible="accordion" style="margin-top: 30px;">
							...
							<li id="ms2" class="active"><a style="color: #fddd72;" href="transactions.php" class="collapsible-header"><!--<i class="zmdi zmdi-swap-vertical icontransaction" style="font-size:30px;"></i>-->Transactions</a></li>
...
?>
			...
			<div>
				...
				<form action="verifyemail.php" method="post">
					<main id="content" class="topmg transactiontop main2-content" style="width:90%">
						<div id="page-content">
							<div class="modal-content">
								<div id="send1ststep">
									<div class="modal-head">
										<div class="col l8">
											<h5><!--<i class="zmdi zmdi-long-arrow-up zmdi-hc-fw"></i>-->Receive Coin</h5>
									...
									<div class="form-horizontal white signUpContainer center" style="width:90%;padding:1%;padding-left:5%">
										<fieldset>
											...
											<div class="row">
												...
												alt="QR Code" style="width:200px;border:0;"/></a></label>
												</div>
											</div>
										</fieldset>
									</div>
