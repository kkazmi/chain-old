						...
						<div class="nav-wrapper" >
							<ul class="left">
								<a href="./myaddress.php" class="brand-logo">
								 <img src="" style="width: 57px;top: 0px !important;">
								</a>
							...
							<div class="col l12 m12 s12 tabmenu">
								<div class="above-prod-table pctrns">
									<div class="col s7 left prod-title-div no-padding" id="ace">
										<a href="transactions.php"><span class="btn btn-default" style="background-color: transparent!important;color: #a2212c;font-size: 14px;border: 0px solid #ececec;box-shadow:none!important;padding: 0px 10px;font-family:'Open Sans', sans-serif;" id="Type_All">All</span></a>
										<a href="sent.php"><span class="btn btn-default" style="background-color: transparent!important;color: #a2212c;font-size: 14px;border: 0px solid #ececec;box-shadow:none!important;padding: 0px 10px;font-family:'Open Sans', sans-serif;" id="Type_Sent">Sent</span></a>
										<a href="recieved.php"><span class="btn btn-default" style="background-color: transparent!important;color: #a2212c;font-size: 14px;border: 0px solid #ececec;box-shadow:none!important;padding: 0px 10px;font-family:'Open Sans', sans-serif;font-weight:bold;text-decoration:underline" id="Type_Receive">Received</span></a>

									</div>
								<!--	<div class="col s1">
										<a href="#" style="float: right;" id="OpenDownloadModal"><i class="zmdi zmdi-download downloadoption"></i></a>
									</div>
									<div class="input-field col s4">
										<input class="validate srh1" placeholder="Search" style="position:relative;" id="search" type="text">
										<i class="fa fa-search active" aria-hidden="true" style="position:absolute;right: 25px;top: 13px;font-size: 16px;"></i>
									</div>
									-->
								</div>
								<div class="above-prod-table mobtrns">
									...
									<div class="col m12 s12 no18">
										...
										<div class="input-field">
											...
											<i class="fa fa-search active" aria-hidden="true" style="position:absolute;right: 15px;top: 13px;font-size: 16px;"></i>
										</div>
									</div>
								</div>
							</div>
